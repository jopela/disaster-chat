...
/**
 * Handle the find value requests: search the storage for the requested key and
...
public class FindvalueHandler extends AbstractDHTHandler {
	...
	public void onIncomingMessage(Node from, String tag, Serializable content) {
		throw new UnsupportedOperationException(
				"find value only accepts requests");
	}
	...
	public Serializable onIncomingRequest(Node from, String tag,
		...
		return findValueResponseProvider.get().setValues(searchResults);
	}
