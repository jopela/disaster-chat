...
public abstract class AbstractDHTHandler implements MessageHandler {
	...
	/**
	 * Register this handler to recv incoming messages from the key based
	 * routing
	 * 
	 * @param dhtName
	 *            associate this handler with a dht according to its name
	 * @param kbr
	 *            the key based routing network
	 */
