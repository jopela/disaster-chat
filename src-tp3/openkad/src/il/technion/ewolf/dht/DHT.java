...
public interface DHT {
	...
	/**
	 * sets the name for the dht to associate different storage classes for
	 * different dhts
	 * 
	 * @param dhtName
	 *            the dht name
	 ...
	 * 
	 * @param key
	 *            the data's key used to retrieve it later
	 * @param data
	 *            the data to be inserted
	 */
	 ...
	 * 
	 * @param tags
	 *            the tags used to insert the data
	 ...
	 * 
	 * @param key
	 *            the key used to insert the data
	 * @return all data items mapped with the given tags
	 */
