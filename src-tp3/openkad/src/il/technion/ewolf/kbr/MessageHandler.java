...
public interface MessageHandler {
	...
	/**
	 * Will be invoked when after registered in KeybasedRouting.register and a
	 * message with the registered tag has arrived using the remote node
	 * KeybasedRouting.sendMessage method
	 * 
	 * @param from
	 *            the sender node
	 * @param tag
	 *            the arrived message tag
	 * @param content
	 *            the sent object
	 */
	 ...
	 * Will be invoked when after registered in KeybasedRouting.register and a
	 * message with the registered tag has arrived using the remote node
	 * KeybasedRouting.sendRequest method
	 * 
	 * @param from
	 *            the sender node
	 * @param tag
