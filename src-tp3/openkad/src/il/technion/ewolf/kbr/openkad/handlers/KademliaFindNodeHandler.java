 ...
 * 
 */
public class KademliaFindNodeHandler extends AbstractHandler implements
		FindNodeHandler {
	...
	public void completed(KadMessage msg, Void attachment) {
		...
		FindNodeResponse findNodeResponse = findNodeRequest.generateResponse(
				localNode).setCachedResults(false);
		...
		if (!findNodeRequest.shouldSearchCache()) {
			...
			if (cachedResults == null) {
				...
				findNodeResponse.setNodes(new ArrayList<Node>(cachedResults))
