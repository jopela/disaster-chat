...
public class ContentMessage extends KadMessage {
	...
	@Inject
	ContentMessage(@Named("openkad.rnd.id") long id,
			@Named("openkad.local.node") Node src) {
		super(id, src);
	}

	/**
	 * Every content request has a tag associated with it. This is the same tag
	 * given in the KeybasedRouting.sendMessage or sendRequest methods.
	 * 
