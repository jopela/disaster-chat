 ...
 * 
 * @author eyal.kibbar@gmail.com we extend the find node response in order for
 *         nodes to be able to indicate if they are interested in the value for
 *         their cache.
 */
public class FindNodeResponse extends KadResponse {
	 ...
	 * 
	 * @see
	 * il.technion.ewolf.kbr.openkad.msg.FindNodeResponse#setNeeeded(boolean)
	 */
