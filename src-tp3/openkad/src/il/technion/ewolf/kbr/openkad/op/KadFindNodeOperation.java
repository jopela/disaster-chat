 ...
 * 
 */
public class KadFindNodeOperation implements
	...
	@Inject
	KadFindNodeOperation(@Named("openkad.local.node") Node localNode,
	 ...
	 * 
	 * @see
	 * il.technion.ewolf.kbr.openkad.op.FindNodeOperation#setKey(il.technion
	 * .ewolf.kbr.Key)
	 */
	@Override
	...
	private void sendFindNode(Node to) {
		FindNodeRequest findNodeRequest = findNodeRequestProvider.get()
				.setSearchCache(false).setKey(key);
